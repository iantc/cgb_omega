...
To use these stylesheets, rename the files and cgb_omega with the name of your theme.
...
cgb_omega-alpha-default-narrow.css  
...
cgb_omega-alpha-default-normal.css
...
cgb_omega-alpha-default-wide.css
